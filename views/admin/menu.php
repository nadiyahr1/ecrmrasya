...
<script>
    function bukaModalTambah() {
        ...
        // Arahkan ke AdminController
        document.getElementById('formMenu').action = 'index.php?controller=admin&action=tambah_menu';
    ...
    function bukaModalEdit(id, nama, id_kat, harga, stok, foto) {
        ...
        // Arahkan ke AdminController
        document.getElementById('formMenu').action = 'index.php?controller=admin&action=edit_menu';
