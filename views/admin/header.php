...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="menu-container">
            <a href="index.php?controller=admin&action=index" class="menu-item <?= ($page == 'dashboard') ? 'active' : '' ?>">Dashboard</a>
            <a href="index.php?controller=admin&action=data_pesanan" class="menu-item <?= ($page == 'data_pesanan') ? 'active' : '' ?>">Pesanan</a>

            <div class="menu-header">Manajemen Data</div>
            <a href="index.php?controller=admin&action=data_pelanggan" class="menu-item <?= ($page == 'data_pelanggan') ? 'active' : '' ?>">Data Pelanggan</a>
            ...
            <div id="dropMenu" class="sub-menu-content <?= (in_array($page, ['menu', 'kategori_menu'])) ? 'buka-dong' : '' ?>">
                <a href="index.php?controller=admin&action=kategori_menu" class="submenu-item">Kategori Menu</a>
                <a href="index.php?controller=admin&action=menu" class="submenu-item">Daftar Menu</a>
            </div>

            <a href="index.php?controller=admin&action=fasilitas" class="menu-item <?= ($page == 'fasilitas') ? 'active' : '' ?>">Data Fasilitas</a>
            <a href="index.php?controller=admin&action=promo" class="menu-item <?= ($page == 'promo') ? 'active' : '' ?>">Data Promo</a>
            <a href="index.php?controller=admin&action=manajemen_meja" class="menu-item <?= ($page == 'manajemen_meja') ? 'active' : '' ?>">Manajemen Meja</a>

            <div class="menu-header">Lainnya</div>
            <a href="index.php?controller=admin&action=ulasan" class="menu-item <?= ($page == 'ulasan') ? 'active' : '' ?>">Ulasan</a>
            ...
            <div id="dropLaporan" class="sub-menu-content <?= (strpos($page, 'laporan') !== false) ? 'buka-dong' : '' ?>">
                <a href="index.php?controller=laporan&action=index" class="submenu-item">• Laporan Penjualan</a>
                <a href="index.php?controller=laporan&action=laporanMember" class="submenu-item">• Aktivitas Member</a>
            </div>
        </div>
    </div>
